...
INSERT INTO `appx`.`_role_grant`(`role_name`, `grant_scope`, `grant_name`, `grant_spec`) VALUES ('appx.superadmin', 'appx.local_auth', 'appx', '{"comment": "initial grant"}');
INSERT INTO `appx`.`_role_scope`(`scope_name`, `scope_spec`) VALUES ('appx.local_auth', '{"comment": "initial scope"}');

INSERT INTO `appx`.`_appx_meta`(`appx_name`, `appx_key`, `appx_info`) VALUES ('appx.version', 'r001.p01', '{"comment": "initial version"}') ON DUPLICATE KEY UPDATE appx_info=VALUES(appx_info);
INSERT INTO `appx`.`_appx_meta`(`appx_name`, `appx_key`, `appx_info`) VALUES ('appx.local_auth', 'appx', JSON_OBJECT('password', PASSWORD("{{appx.init.admin_password}}"), 'comment', 'initial version')) ON DUPLICATE KEY UPDATE appx_info=VALUES(appx_info);
